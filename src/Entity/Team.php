...
#[ApiResource(
    operations: [
        ...
        new Get(
            uriTemplate: 'teams/{id}/hunts',
            openapi: new Operation(
                summary: 'Designer Teams treasure hunts',
                description: 'Retrieve detailed informations of the treasure hunts designed from a specific team by their ID. Requires ROLE_USER permission.'
            ),
