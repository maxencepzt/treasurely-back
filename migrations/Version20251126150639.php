 ...
 */
final class Version20251126150639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE treasure_hunt ALTER updated_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE treasure_hunt ALTER updated_at TYPE DATE');
        $this->addSql('COMMENT ON COLUMN treasure_hunt.created_at IS \'(DC2Type:date_immutable)\'');
        $this->addSql('COMMENT ON COLUMN treasure_hunt.updated_at IS \'(DC2Type:date_immutable)\'');
    }
}
